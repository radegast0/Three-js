...
function updateFragmentShader(fragmentShader2) {
  if (revision < 154) {
    return fragmentShader2.replace("colorspace_fragment", "encodings_fragment");
  }
...
var seed = function seed2(_seed) {
  ...
  for (var i2 = 0; i2 < 256; i2++) {
    ...
    perm[i2] = perm[i2 + 256] = v3;
    gradP[i2] = gradP[i2 + 256] = grad3[v3 % 12];
  }
};
seed(0);
...
var perlin3 = function perlin32(x, y, z) {
  ...
  var v3 = fade(y);
  var w = fade(z);
  return lerp(lerp(lerp(n000, n100, u), lerp(n001, n101, u), w), lerp(lerp(n010, n110, u), lerp(n011, n111, u), w), v3);
};
